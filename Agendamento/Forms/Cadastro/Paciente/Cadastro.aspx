<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Agendamento.master" AutoEventWireup="true" CodeFile="Cadastro.aspx.cs" Inherits="Forms_Cadastro_Paciente_Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="auto-style1">
            ...
            <br />
                    ...
                    <br />
                    <a>Cpf</a><br />
                    <asp:TextBox runat="server" ID="txtCpf" Width="600" MaxLength="18" onkeypress="Mascara(this,Cpf);" ValidationGroup="gravar"></asp:TextBox>
                    <asp:RequiredFieldValidator runat="server" ID="r3" ControlToValidate="txtCpf" ValidationGroup="gravar"
